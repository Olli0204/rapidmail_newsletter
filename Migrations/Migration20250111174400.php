...
class Migration20250111174400 extends Migration implements IMigration
{
    public function up()
    {
        $this->execute(
            ...
            ");
        $this->execute(
            "CREATE TABLE `rapidmail_sync_table` (`id` INT(11) AUTO_INCREMENT, `kNewsletterempfaenger` INT(11) NOT NULL, `kInternalListId` INT(11) NOT NULL, PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1;"
        );
    }
